 ...
 * @since 1.0.1
 */
public class CacheInterceptorEvictUpdate<K,V> extends AbstractCacheInterceptor<K, V> {

    private static final Log log = LogFactory.getLog(CacheInterceptorEvictUpdate.class);

    @Override
    protected String getType() {
        return CacheInterceptorType.EVICT_UPDATE.code();
    }
